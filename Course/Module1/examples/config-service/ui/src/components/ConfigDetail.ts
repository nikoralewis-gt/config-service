...
import type { ConfigurationResponse, LoadingState } from '@/types/api.js';
...
export class ConfigDetail extends BaseComponent {
  ...
  private async loadConfiguration(): Promise<void> {
    ...
    const result = await api.getConfiguration(appId);
  ...
  private async saveConfiguration(): Promise<void> {
    ...
    try {
      ...
      const result = await api.updateConfiguration(appId, { config });
