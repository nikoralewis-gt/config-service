...
3. `memory/IMPLEMENTATION.md`
   - Technologies used
   - Development setup
   - Technical constraints
   - Dependencies
   - Tool usage patterns
   - Testing strategies and mock policies

4. `memory/ENV_SCRIPTS.md`
   - Environment setup procedures
   - Development commands and scripts
   - Local development workflow
   - Tooling and automation details

5. `memory/WORKFLOW_STATUS.md`
   - Current development workflow
   - Work item process and commit practices
...
2. VALIDATION MECHANISM
   ...
   - Immediate action: Read memory files in this EXACT order:
     ...
     c. memory/IMPLEMENTATION.md
     d. memory/ENV_SCRIPTS.md
     e. memory/WORKFLOW_STATUS.md
